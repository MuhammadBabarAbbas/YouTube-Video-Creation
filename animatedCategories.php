...
$backgrounds = glob('images/backgrounds/winnie-the-pooh/*.png');
    ...
    foreach (range('A', 'Z') as $alphabet) {
        if (isset($animation_vocabulary[$alphabet])) {
            ...
            for ($i = 1; $i <= 30; $i++) {
                ...
                //$background = imagecreatefrompng($backgroundFramesDirectroy . '/frame' . ($i) . '.png');
                ...
                $animatedGifPath = 'images/animations/winnie-the-pooh/' . $actualword . '.gif';
                $animatedGifName = basename($animatedGifPath);

                $animatedGifFramesDirectroy = str_replace(".gif", "", "images/animations/winnie-the-pooh/" .
                    $animatedGifName);
                ...
                if (file_exists($animatedGifPath) && sizeof($animatedGifExtractedFrames) == 0) {
                    ...
                    foreach ($animatedGifExtractedFrames as $animatedGifExtractedFrame) {
                        ...
                        $newimage = resize_image($animatedGifExtractedFrame, 500, 430, false);
